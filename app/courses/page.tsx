                ...
                <li key={label}>
                  <Link 
                    ...
                    className={`text-[15px] font-medium transition-colors ${
                      label === "Courses" ? "text-[#8B5CF6]" : "text-[#6B7280] hover:text-[#111827]"
                    }`}
                  >
                    {label}
                  </Link>
          ...
          {mobileMenuOpen && (
            ...
            >
              {["Courses", "About Us", "Contact Us"].map((label) => {
                const href = label === "Courses" ? "/courses" : label === "About Us" ? "/about" : "/contact";
                return (
                  <Link key={label} href={href} onClick={() => setMobileMenuOpen(false)} className="text-[#6B7280] font-medium text-[16px]">
                    {label}
                  </Link>
                );
              })}
              <a href="/#pricing" onClick={() => setMobileMenuOpen(false)} className="bg-[#111827] text-white w-full text-center py-3.5 text-[15px] font-semibold rounded-full">
                Start Learning Now
              </a>
            </motion.div>
          )}
