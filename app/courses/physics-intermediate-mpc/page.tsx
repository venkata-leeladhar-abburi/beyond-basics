      ...
      <section className="relative pt-[160px] pb-[80px] px-6 bg-white overflow-hidden">
        ...
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="flex items-center gap-2 text-[14px] text-[#6B7280] mb-8 font-medium">
            ...
            <span className="text-[#8B5CF6]">Physics for Intermediate — MPC Complete Course</span>
          </div>
          ...
          <div className="grid lg:grid-cols-[1fr_500px] gap-16 items-start">
            <motion.div initial="hidden" animate="show" variants={staggerContainer}>
              <motion.h1 variants={fadeUp} className="text-[44px] md:text-[50px] font-bold tracking-tight text-[#111827] leading-[1.2] mb-6 font-poppins">
                Physics for Intermediate — MPC Complete Course
              </motion.h1>
              
              <motion.p variants={fadeUp} className="text-[16px] md:text-[18px] text-[#6B7280] max-w-[600px] leading-[1.6] mb-10 font-medium">
                Full Intermediate Physics — 1st Year & 2nd Year — covered with derivations, diagrams, and numericals. Built for students who want to ace IPE and walk into EAMCET or JEE with real confidence.
              </motion.p>
            ...
            >
              <img src="https://images.unsplash.com/photo-1636466497217-26a8cbeaf0aa?auto=format&fit=crop&q=80&w=800&h=500" alt="Course Preview" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
            ...
            <div className="space-y-16">
              ...
              <div>
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  {[
                    "Full 1st & 2nd Year Coverage",
                    "Every Important Derivation Explained",
                    "600+ Numerical Problems Solved",
                    "IPE + EAMCET + JEE Focused",
                    "Concept-Based, Not Rote Learning",
                    "Previous Year Questions Covered",
                    "Notes, Diagrams & Formula Sheets"
                  ].map((benefit, i) => (
              ...
              <div>
                ...
                <div className="space-y-4">
                  {[
                    { title: "Module 1: Mechanics & Properties of Matter", lessons: ["Physical World", "Units and Measurements", "Motion in a Straight Line", "Motion in a Plane", "Laws of Motion", "Work, Energy and Power", "Systems of Particles and Rotational Motion", "Oscillations", "Gravitation", "Mechanical Properties of Solids", "Mechanical Properties of Fluids"] },
                    { title: "Module 2: Heat & Thermodynamics", lessons: ["Thermal Properties of Matter", "Thermodynamics", "Kinetic Theory"] },
                    { title: "Module 3: Waves & Optics", lessons: ["Waves", "Ray Optics and Optical Instruments", "Wave Optics"] },
                    { title: "Module 4: Electricity & Magnetism", lessons: ["Electric Charges and Fields", "Electrostatic Potential and Capacitance", "Current Electricity", "Moving Charges and Magnetism", "Magnetism and Matter", "Electromagnetic Induction", "Alternating Current", "Electromagnetic Waves"] },
                    { title: "Module 5: Modern Physics", lessons: ["Dual Nature of Radiation and Matter", "Atoms", "Nuclei", "Semiconductor Electronics: Materials, Devices and Simple Circuits", "Communication Systems"] }
                  ].map((module, i) => (
                ...
                <div className="relative z-10 flex flex-col md:flex-row gap-12 items-center">
                  <div className="flex-1">
                    ...
                    <div className="space-y-6 text-[15px] text-[#9CA3AF] leading-[1.6]">
                      <div>
                        <h4 className="text-white font-bold mb-2">Physics Faculty (Intermediate & JEE) — Beyond Basics</h4>
                        <p>9+ years of experience in teaching Intermediate Physics across AP and Telangana. A numerical-problem specialist who has helped over 3,000 students crack EAMCET. Passionate about making Physics feel intuitive — not intimidating — through concept-first teaching and patient explanation.</p>
                      </div>
              ...
              <div className="bg-white rounded-[32px] p-8 border border-[#F3F4F6] shadow-[0_20px_50px_rgba(0,0,0,0.04)]">
                <div className="mb-8">
                  ...
                  <div className="flex items-baseline gap-1">
                    <span className="text-[40px] font-bold text-[#111827]">₹1,199</span>
