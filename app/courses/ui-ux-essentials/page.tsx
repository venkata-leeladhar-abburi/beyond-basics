...
export default function UiUxCourseDetailPage() {
  ...
  return (
    <div className="min-h-screen bg-[#F9FAFB] text-[#111827] overflow-hidden font-inter selection:bg-[#8B5CF6]/20">
      ...
      <div className="absolute top-40 right-1/4 w-[600px] h-[600px] bg-[#FDF4FF] opacity-50 blur-[120px] -z-10 rounded-full" />
      ...
      <section className="relative pt-[160px] pb-[100px] px-6 overflow-hidden">
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="flex items-center gap-2 text-[14px] text-[#6B7280] mb-8 font-medium">
            ...
            <span className="text-[#8B5CF6]">UI/UX Essentials</span>
          </div>
          ...
          <div className="grid lg:grid-cols-[1fr_500px] gap-16 items-start">
            <motion.div initial="hidden" animate="show" variants={staggerContainer}>
              ...
              <motion.p variants={fadeUp} className="text-[16px] md:text-[18px] text-[#6B7280] max-w-[600px] leading-[1.6] mb-10 font-medium">
                Learn modern UI and UX design through practical projects, user-centered thinking, wireframing, prototyping, and real-world design workflows.
              </motion.p>
            ...
            >
              <iframe 
                src="https://share.synthesia.io/embeds/videos/8e824704-b648-48e4-bc3b-5c0c55732571" 
                loading="lazy" 
                title="Synthesia video player - ui/ux essentials" 
                allowFullScreen 
            ...
            <div className="space-y-16">
              ...
              <div>
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  {[
                    ...
                    "Learn prototyping workflows",
                    "Improve design thinking",
                    "Work with modern tools like Figma"
                  ].map((benefit, i) => (
              ...
              <div>
                ...
                <div className="space-y-4">
                  {[
                    { title: "Module 1: Introduction to UI/UX", lessons: ["What is UI and UX", "Importance of user-centered design", "Design process overview"] },
                    { title: "Module 2: User Research", lessons: ["Understanding users", "Personas", "User journeys", "Pain points"] },
                    { title: "Module 3: Wireframing", lessons: ["Low-fidelity wireframes", "Layout structures", "Information hierarchy"] },
                    { title: "Module 4: UI Design Fundamentals", lessons: ["Typography", "Color systems", "Spacing", "Visual hierarchy"] },
                    { title: "Module 5: Figma Essentials", lessons: ["Components", "Auto layout", "Design systems", "Prototyping"] },
                    { title: "Module 6: Responsive Design", lessons: ["Mobile-first interfaces", "Tablet layouts", "Desktop responsiveness"] },
                    { title: "Module 7: Real-World Projects", lessons: ["Mobile app design", "SaaS dashboard", "Landing page design", "Portfolio project"] }
                  ].map((module, i) => (
                ...
                <div className="relative z-10 flex flex-col md:flex-row gap-12 items-center">
                  <div className="flex-1">
                    ...
                    <div className="space-y-4 text-[15px] text-[#9CA3AF] leading-[1.6]">
                      <h4 className="text-white font-bold text-[18px]">UI/UX Design Faculty — Shraddha</h4>
                      <p>6+ years of experience in product design. Has worked with top startups and is an expert in Figma and user-centered design methodologies.</p>
              ...
              <div className="bg-white rounded-[32px] p-8 border border-[#E5E7EB] shadow-[0_20px_50px_rgba(0,0,0,0.04)]">
                ...
                <div className="pt-8 border-t border-[#E5E7EB]">
                  ...
                  <ul className="space-y-4">
                    {[
                      { text: "35+ lessons", icon: Play },
                      { text: "10+ resources", icon: Download },
                      { text: "Practical assignments", icon: ListChecks },
                      { text: "10 hours of content", icon: Clock },
      ...
      <section className="py-[120px] px-6 bg-[#F9FAFB] overflow-hidden text-center">
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="flex flex-wrap justify-center gap-3">
            {["UI Design", "UX Design", "Figma", "Wireframing", "Prototyping", "Design Systems", "Responsive Design", "Mobile UI", "Typography", "User Research"].map((topic, i) => (
      ...
      <section className="relative py-[140px] px-6 overflow-hidden">
        {/* Soft lavender/pink ambient gradient */}
        ...
        <div className="max-w-[800px] mx-auto text-center relative z-10">
          ...
          >
            <h2 className="text-[40px] md:text-[48px] font-bold tracking-tight text-[#111827] mb-6 font-poppins">
              Design Better Experiences with Shraddha
            </h2>
            <p className="text-[#6B7280] text-[18px] max-w-[600px] mx-auto mb-10 font-medium leading-[1.6]">
              Thousands of students trust Shraddha to learn modern digital design and creative skills.
            </p>
