      ...
      <section className="relative pt-[160px] pb-[80px] px-6 bg-white overflow-hidden">
        ...
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="flex items-center gap-2 text-[14px] text-[#6B7280] mb-8 font-medium">
            ...
            <span className="text-[#8B5CF6]">Mathematics Mastery — Class 10th</span>
          </div>
          ...
          <div className="grid lg:grid-cols-[1fr_500px] gap-16 items-start">
            <motion.div initial="hidden" animate="show" variants={staggerContainer}>
              <motion.h1 variants={fadeUp} className="text-[44px] md:text-[50px] font-bold tracking-tight text-[#111827] leading-[1.2] mb-6 font-poppins">
                Mathematics Mastery — Class 10th
              </motion.h1>
              
              <motion.p variants={fadeUp} className="text-[16px] md:text-[18px] text-[#6B7280] max-w-[600px] leading-[1.6] mb-10 font-medium">
                Stop fearing Maths. Master every CBSE/State Board chapter with crystal-clear video lessons, 500+ solved problems, and board exam shortcuts that actually work.
              </motion.p>
            ...
            >
              <img src="https://images.unsplash.com/photo-1518133910546-b6c2fb7d79e3?auto=format&fit=crop&q=80&w=800&h=500" alt="Course Preview" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
            ...
            <div className="space-y-16">
              ...
              <div>
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  {[
                    ...
                    "Concept Clarity — No Mugging",
                    "Speed & Shortcut Techniques",
              ...
              <div>
                ...
                <div className="space-y-4">
                  {[
                    { title: "Module 1: Number Systems", lessons: ["Real Numbers", "Euclid's Division Lemma", "Fundamental Theorem of Arithmetic"] },
                    { title: "Module 2: Algebra", lessons: ["Polynomials", "Pair of Linear Equations", "Quadratic Equations", "Arithmetic Progressions"] },
                    { title: "Module 3: Coordinate Geometry", lessons: ["Distance Formula", "Section Formula", "Area of a Triangle"] },
                    { title: "Module 4: Geometry", lessons: ["Triangles", "Circles", "Constructions"] },
                    { title: "Module 5: Trigonometry", lessons: ["Introduction to Trigonometry", "Trigonometric Identities", "Heights and Distances"] },
                    { title: "Module 6: Mensuration", lessons: ["Areas Related to Circles", "Surface Areas and Volumes"] },
                    { title: "Module 7: Statistics and Probability", lessons: ["Mean, Median, Mode", "Probability Basics"] }
                  ].map((module, i) => (
                ...
                <div className="relative z-10 flex flex-col md:flex-row gap-12 items-center">
                  <div className="flex-1">
                    ...
                    <div className="space-y-6 text-[15px] text-[#9CA3AF] leading-[1.6]">
                      <div>
                        <h4 className="text-white font-bold mb-2">Senior Maths Faculty — Beyond Basics</h4>
                        <p>With over 8 years of experience teaching Class 10th and Intermediate Maths, our faculty has helped more than 5,000 students crack board exams with confidence. Known for breaking down complex problems into simple, logical steps — this is Maths the way it should always have been taught.</p>
                      </div>
