      ...
      <section className="relative pt-[160px] pb-[80px] px-6 bg-white overflow-hidden">
        ...
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="flex items-center gap-2 text-[14px] text-[#6B7280] mb-8 font-medium">
            ...
            <span className="text-[#8B5CF6]">Python Programming — B.Tech Full Mastery</span>
          </div>
          ...
          <div className="grid lg:grid-cols-[1fr_500px] gap-16 items-start">
            <motion.div initial="hidden" animate="show" variants={staggerContainer}>
              <motion.h1 variants={fadeUp} className="text-[44px] md:text-[50px] font-bold tracking-tight text-[#111827] leading-[1.2] mb-6 font-poppins">
                Python Programming — B.Tech Full Mastery
              </motion.h1>
              
              <motion.p variants={fadeUp} className="text-[16px] md:text-[18px] text-[#6B7280] max-w-[600px] leading-[1.6] mb-10 font-medium">
                Go from complete beginner to confident Python programmer. Built specifically for B.Tech students — covers everything from basics to OOP, Data Structures, File Handling, and real-world mini projects.
              </motion.p>
            ...
            >
              <img src="https://images.unsplash.com/photo-1526379095098-d400fd0bf935?auto=format&fit=crop&q=80&w=800&h=500" alt="Course Preview" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
            ...
            <div className="space-y-16">
              ...
              <div>
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  {[
                    "Python from Scratch to Advanced",
                    "Object-Oriented Programming (OOP)",
                    "Data Structures with Python",
                    "5 Real-World Mini Projects",
                    "B.Tech Exam + Lab Record Ready",
              ...
              <div>
                ...
                <div className="space-y-4">
                  {[
                    { title: "Module 1: Introduction & Environment Setup", lessons: ["Introduction to Python", "Installing Python & VS Code", "Writing Your First Program", "How Python Works (Interpreter vs Compiler)"] },
                    { title: "Module 2: Variables, Data Types & Operators", lessons: ["Variables & Constants", "Numbers, Strings, Booleans", "Type Casting", "Arithmetic, Logical & Bitwise Operators"] },
                    { title: "Module 3: Control Flow", lessons: ["If-Else Statements", "Match-Case (Switch)", "For Loops & While Loops", "Break, Continue & Pass"] },
                    { title: "Module 4: Functions & Modules", lessons: ["Defining Functions", "Arguments & Return Values", "Lambda Functions", "Importing Standard Modules (math, random, datetime)"] },
                    { title: "Module 5: Data Structures", lessons: ["Lists & List Comprehension", "Tuples & Sets", "Dictionaries in Depth", "Slicing & Indexing"] },
                    { title: "Module 6: Object-Oriented Programming (OOP)", lessons: ["Classes & Objects", "Constructors (__init__)", "Inheritance & Polymorphism", "Encapsulation & Abstraction"] },
                    { title: "Module 7: File Handling & Exception Handling", lessons: ["Reading & Writing Files", "Try-Except-Finally Blocks", "Custom Exceptions", "Working with JSON Files"] }
                  ].map((module, i) => (
              ...
              <div className="bg-white rounded-[32px] p-8 border border-[#F3F4F6] shadow-[0_20px_50px_rgba(0,0,0,0.04)]">
                <div className="mb-8">
                  ...
                  <div className="flex items-baseline gap-1">
                    <span className="text-[40px] font-bold text-[#111827]">₹1,499</span>
