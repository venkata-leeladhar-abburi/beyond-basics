      ...
      <section className="relative pt-[160px] pb-[80px] px-6 bg-white overflow-hidden">
        ...
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="flex items-center gap-2 text-[14px] text-[#6B7280] mb-8 font-medium">
            ...
            <span className="text-[#8B5CF6]">Science Mastery — Class 10th</span>
          </div>
          ...
          <div className="grid lg:grid-cols-[1fr_500px] gap-16 items-start">
            <motion.div initial="hidden" animate="show" variants={staggerContainer}>
              <motion.h1 variants={fadeUp} className="text-[44px] md:text-[50px] font-bold tracking-tight text-[#111827] leading-[1.2] mb-6 font-poppins">
                Science Mastery — Class 10th
              </motion.h1>
              
              <motion.p variants={fadeUp} className="text-[16px] md:text-[18px] text-[#6B7280] max-w-[600px] leading-[1.6] mb-10 font-medium">
                Physics, Chemistry & Biology — mastered in one course. Crystal-clear explanations, diagrams, and board-focused practice that turns confusion into confidence.
              </motion.p>
            ...
            >
              <img src="https://images.unsplash.com/photo-1532094349884-543bc11b234d?auto=format&fit=crop&q=80&w=800&h=500" alt="Course Preview" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
            ...
            <div className="space-y-16">
              ...
              <div>
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  {[
                    ...
                    "Clear Diagrams & Explanations",
                    "Previous Year Questions Solved",
                    "Board Exam Success Shortcuts",
                    "90+ Score Focused Curriculum",
              ...
              <div>
                ...
                <div className="space-y-4">
                  {[
                    { title: "Module 1: Chemical Substances", lessons: ["Chemical Reactions and Equations", "Acids, Bases and Salts", "Metals and Non-metals", "Carbon and its Compounds"] },
                    { title: "Module 2: World of Living", lessons: ["Life Processes", "Control and Coordination", "How do Organisms Reproduce?", "Heredity and Evolution"] },
                    { title: "Module 3: Natural Phenomena", lessons: ["Reflection of Light", "Refraction of Light", "The Human Eye and the Colourful World"] },
                    { title: "Module 4: Effects of Current", lessons: ["Electricity", "Magnetic Effects of Electric Current"] },
                    { title: "Module 5: Natural Resources", lessons: ["Our Environment", "Sustainable Management of Natural Resources"] }
                  ].map((module, i) => (
