      ...
      <section className="relative pt-[160px] pb-[80px] px-6 bg-white overflow-hidden">
        ...
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="flex items-center gap-2 text-[14px] text-[#6B7280] mb-8 font-medium">
            ...
            <span className="text-[#8B5CF6]">Data Structures & Algorithms — B.Tech Mastery</span>
          </div>
          ...
          <div className="grid lg:grid-cols-[1fr_500px] gap-16 items-start">
            <motion.div initial="hidden" animate="show" variants={staggerContainer}>
              <motion.h1 variants={fadeUp} className="text-[44px] md:text-[50px] font-bold tracking-tight text-[#111827] leading-[1.2] mb-6 font-poppins">
                Data Structures & Algorithms — B.Tech Mastery
              </motion.h1>
              
              <motion.p variants={fadeUp} className="text-[16px] md:text-[18px] text-[#6B7280] max-w-[600px] leading-[1.6] mb-10 font-medium">
                The most complete DSA course for B.Tech students. From Arrays to Dynamic Programming — master every data structure and algorithm you need for university exams, GATE preparation, and campus placement coding rounds.
              </motion.p>
            ...
            >
              <img src="https://images.unsplash.com/photo-1504639725590-34d0984388bd?auto=format&fit=crop&q=80&w=800&h=500" alt="Course Preview" className="w-full h-full object-cover transition-transform duration-700 group-hover:scale-105" />
            ...
            <div className="space-y-16">
              ...
              <div>
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  {[
                    "All Major Data Structures Covered",
                    "Algorithm Complexity Analysis (Big-O)",
                    "Placement Coding Round Preparation",
                    "B.Tech Exam & GATE Ready",
                    "Problem-Solving Mindset Built",
                    "300+ Practice Problems Solved",
                    "Dynamic Programming — Full Module"
                  ].map((benefit, i) => (
              ...
              <div>
                ...
                <div className="space-y-4">
                  {[
                    { title: "Module 1: Basic Data Structures", lessons: ["Arrays", "Linked Lists", "Stacks & Queues"] },
                    { title: "Module 2: Advanced Data Structures", lessons: ["Trees", "Graphs", "Heaps", "Hash Tables"] },
                    { title: "Module 3: Core Algorithms", lessons: ["Sorting & Searching", "Divide & Conquer", "Greedy Algorithms"] },
                    { title: "Module 4: Dynamic Programming", lessons: ["1D & 2D DP", "Knapsack Variants", "Path Problems"] }
                  ].map((module, i) => (
                ...
                <div className="relative z-10 flex flex-col md:flex-row gap-12 items-center">
                  <div className="flex-1">
                    ...
                    <div className="space-y-6 text-[15px] text-[#9CA3AF] leading-[1.6]">
                      <div>
                        <h4 className="text-white font-bold mb-2">DSA Expert & Placement Trainer — Beyond Basics</h4>
                        <p>A software engineer with experience at product-based companies and a passionate educator who has trained 3,000+ B.Tech students for campus placements. Specialises in making DSA visual, logical, and approachable — breaking down complex algorithms into steps any student can follow. Has a 90% placement success rate among students who completed this course.</p>
                      </div>
